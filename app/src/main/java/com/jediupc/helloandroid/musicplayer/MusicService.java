...
public class MusicService extends Service {
    ...
    public static final String ACTION_PERMISSION_GRANTED = "action_permision_granted" ;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent.getAction().equals(ACTION_PERMISSION_GRANTED)) mMusic = getMusic();
    ...
    private void updateNotification() {
        ...
        //Mantener activo con el foreground
        if(isPlaying()) {
